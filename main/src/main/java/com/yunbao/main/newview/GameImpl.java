...
import com.yunbao.live.socket.SocketGameUtil;

public class GameImpl implements GameActionListener {

    private LiveAudienceViewHolder mLiveActivity;
    private SocketClient mSocketClient;

    public     GameImpl(LiveAudienceViewHolder liveActivity, SocketClient socketClient) {
