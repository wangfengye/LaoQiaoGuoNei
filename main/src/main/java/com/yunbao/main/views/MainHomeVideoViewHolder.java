...
public class MainHomeVideoViewHolder extends AbsMainHomeChildViewHolder implements OnItemClickListener<VideoBean> {
    ...
    public MainHomeVideoViewHolder(Context context, ViewGroup parentView, VideoPlayWrapViewHolder.OnClickPaihangListener listener) {
    ...
    protected void processArguments(Object... args) {
        ...
        mOnClickPaihangListener= (VideoPlayWrapViewHolder.OnClickPaihangListener) args[0];
    }
        ...
        VideoHttpUtil.getHomeVideoList(1, new HttpCallback() {
            ...
            public void onSuccess(int code, String msg, String[] info) {
                ...
                VideoStorge.getInstance().put(Constants.VIDEO_HOME, list);
                 mVideoScrollViewHolder = new VideoScrollViewHolder(mContext,
                        (ViewGroup) findViewById(com.yunbao.video.R.id.container), 0,
                        Constants.VIDEO_HOME, 1,mOnClickPaihangListener);
...
//        });
    ...
    public void onPause() {
        super.onPause();
        if (mVideoScrollViewHolder!=null)mVideoScrollViewHolder.onPause();
    }
}
