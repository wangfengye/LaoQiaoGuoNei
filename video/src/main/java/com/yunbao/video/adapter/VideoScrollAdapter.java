...
public class VideoScrollAdapter extends RecyclerView.Adapter<VideoScrollAdapter.Vh> implements ItemSlideHelper.Callback {
    ...
    public VideoPlayWrapViewHolder.OnClickPaihangListener mOnClickPaihangListener;

    public VideoScrollAdapter(Context context, List<VideoBean> list, int curPosition, VideoPlayWrapViewHolder.OnClickPaihangListener listener) {
        mContext = context;
        mList = list;
        ...
        mOnClickPaihangListener=listener;
    ...
    public Vh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        Log.e(TAG, "onCreateViewHolder: " +(mOnClickPaihangListener==null?"null":"has"));
        vpvh.setOnClickPaihangListener(mOnClickPaihangListener);
