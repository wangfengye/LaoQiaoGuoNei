...
public class VideoPlayWrapViewHolder extends AbsViewHolder implements View.OnClickListener {
    ...
    public static interface OnClickPaihangListener{
        void click();
    }
    private OnClickPaihangListener clickPaihangListener;
    public void setOnClickPaihangListener(OnClickPaihangListener listener){
        Log.e("TAG", "setOnClickPaihangListener: "+(listener==null?"null":"has"));
        this.clickPaihangListener=listener;
    }
    @Override
    public void onClick(View v) {
        ...
        if (i == R.id.btn_follow) {
            ...
            Log.e("TAG", "onClick: ph" );
            //click paihang
            if(clickPaihangListener!=null)clickPaihangListener.click();
        }
    }
    ...
    private void clickComment() {
        ((ICommentViewListener) mContext).openCommentWindow(mVideoBean.getId(), mVideoBean.getUid());
    }
    ...
    private void clickShare() {
        ...
        fragment.show(((AbsActivity) mContext).getSupportFragmentManager(), "VideoShareDialogFragment");
    }
