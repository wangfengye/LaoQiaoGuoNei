...
public class VideoScrollViewHolder extends AbsViewHolder implements
    ...
    public VideoScrollViewHolder(Context context, ViewGroup parentView, int position, String videoKey, int page,VideoPlayWrapViewHolder.OnClickPaihangListener onClickPaihangListener) {
        super(context, parentView, position, videoKey, page,onClickPaihangListener);
    ...
    protected void processArguments(Object... args) {
        ...
        mPage = (int) args[2];
        mOnClickPaihangListener= (VideoPlayWrapViewHolder.OnClickPaihangListener) args[3];
    }
    ...
    public void init() {
        ...
        mVideoScrollAdapter = new VideoScrollAdapter(mContext, list, mPosition,mOnClickPaihangListener);
