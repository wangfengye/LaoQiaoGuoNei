...
public class VideoPlayActivity extends AbsVideoPlayActivity  {
    ...
    protected void main() {
        ...
        mVideoScrollViewHolder = new VideoScrollViewHolder(mContext, (ViewGroup) findViewById(R.id.container), position, mVideoKey, page, new VideoPlayWrapViewHolder.OnClickPaihangListener() {
            @Override
            public void click() {
                Log.e("TTT", "click: ");
            }
